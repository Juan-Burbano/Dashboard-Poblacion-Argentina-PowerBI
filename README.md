...
## Tablas del modelo
![Tabla Capitales](tabla_capitales.png)
![Tabla Población](tabla_poblacion.png)
![Tabla Provincias-Capitales](tabla_provincias_capitales.png)
...
| Archivo | Descripción |
|--------|-------------|
| [analisis_geografico_argentina.pbix](analisis_geografico_argentina.pbix) | Archivo Power BI con el dashboard completo |
